...
class LeafSpineTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Leaves
        leaf1 = self.addSwitch('leaf1', cpuport=CPU_PORT)  # gRPC 50001
        leaf2 = self.addSwitch('leaf2', cpuport=CPU_PORT)  # gRPC 50002

        # Spines
        spine1 = self.addSwitch('spine1', cpuport=CPU_PORT)  # gRPC 50003
        spine2 = self.addSwitch('spine2', cpuport=CPU_PORT)  # gRPC 50004

        # Links
        self.addLink(spine1, leaf1)
        self.addLink(spine2, leaf2)
        self.addLink(spine1, spine2)
        ...
        h3 = self.addHost('h3', cls=RoutedHost, mac='00:aa:00:00:00:03',
                          ips=['10.0.2.2/24'], gateway='10.0.2.254')
